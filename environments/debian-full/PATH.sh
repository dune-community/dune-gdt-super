...
export F77=gfortran
export CMAKE_FLAGS="-DCMAKE_PREFIX_PATH=$INSTALL_PREFIX -DCMAKE_DISABLE_FIND_PACKAGE_MPI=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_METIS=TRUE -DCMAKE_DISABLE_FIND_PACKAGE_TBB=TRUE"
