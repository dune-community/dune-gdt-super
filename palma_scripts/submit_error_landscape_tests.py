...
stokes_deim_tol = 0
product_type = "l2"
for pfield_tol in (1e-01, 1e-02, 1e-03, 1e-04, 1e-05):
    for pfield_deim_tol in (1e-06, 1e-07, 1e-08, 1e-09, 1e-10):
# for ofield_tol in (1e-01, 1e-02, 1e-03, 1e-04, 1e-05):
#     for ofield_deim_tol in (1e-06, 1e-07, 1e-08, 1e-09, 1e-10):
# for stokes_tol in (1e-01, 1e-02, 1e-03, 1e-04, 1e-05):
#     for stokes_deim_tol in (1e-06, 1e-07, 1e-08, 1e-09, 1e-10):
            ...
            filecontents = filetemplate.replace('JOB_TIME', job_time) \
